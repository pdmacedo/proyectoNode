...
const prodMongo = new ContenedorMongoDB('./daos/userModel/productosUserModel');
const prodFirebase = new ContenedorFirebase('./daos/userModel/productosUserModel');
// const carMongo = new ContenedorMongoDB('./daos/userModel/carritosUserModel');
// const carFirebase = new ContenedorFirebase('./daos/userModel/carritosUserModel');
